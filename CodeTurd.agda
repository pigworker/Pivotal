...
{-----------------------------------------------------------------------------}
  ...
  ins23 {su n} [ x ] < lp / p / pu > | le with ins23 [ x ] lp
  ins23 {su n} [ x ] < lp / p / pu > | le | inl lp'
    = inl < lp' / p / pu >
  ins23 {su n} [ x ] (node2 lp p pu)      | le | inr (ly / y / yp)
    = inl (node3 ly y yp p pu)
  ins23 {su n} [ x ] (node3 lp p pr r ru) | le | inr (ly / y / yp)
    = inr (node2 ly y yp / p / node2 pr r ru)
  ins23 {su n} [ x ] (node2 lp p pu)      | ge with ins23 [ x ] pu
  ins23 {su n} [ x ] (node2 lp p pu)      | ge | inl pu'
    = inl (node2 lp p pu')
  ins23 {su n} [ x ] (node2 lp p pu)      | ge | inr (pr / r / ru)
    = inl (node3 lp p pr r ru)
  ins23 {su n} [ x ] (node3 lp p pr r ru) | ge with owoto x r
  ins23 {su n} [ x ] (node3 lp p pr r ru) | ge | le with ins23 [ x ] pr
  ins23 {su n} [ x ] (node3 lp p pr r ru) | ge | le | inl pr'
    = inl (node3 lp p pr' r ru)
  ins23 {su n} [ x ] (node3 lp p pr r ru) | ge | le | inr (pq / q / qr)
    = inr (node2 lp p pq / q / node2 qr r ru)
  ins23 {su n} [ x ] (node3 lp p pr r ru) | ge | ge with ins23 [ x ] ru
  ins23 {su n} [ x ] (node3 lp p pr r ru) | ge | ge | inl ru'
    = inl (node3 lp p pr r ru')
  ins23 {su n} [ x ] (node3 lp p pr r ru) | ge | ge | inr (rt / t / tu)
    = inr (node2 lp p pr / r / node2 rt t tu)
